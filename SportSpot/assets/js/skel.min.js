...
var skel = function () {
    ...
    var t = {breakpointIds: null, events: {}, isInit: !1, obj: {attachments: {}, breakpoints: {}, head: null, states: {}}, sd: "/", state: null, stateHandlers: {}, stateId: "", vars: {}, DOMReady: null, indexOf: null, isArray: null, iterate: null, matchesMedia: null, extend: function (e, n) {
            ...
            return t.iterate(i, function (e) {
                ...
                t.events[r] || (t.events[r] = []), t.events[r].push(n)
            }), t
        }, trigger: function (e) {
            ...
            document.addEventListener ? !function (e, n) {
                ...
                var e, n = [], i = document, r = "DOMContentLoaded", a = /^loaded|^c/.test(i.readyState);
                return i.addEventListener(r, e = function () {
                    i.removeEventListener(r, e), t()
                }), function (t) {
                    a ? t() : n.push(t)
                }
            }) : !function (e, n) {
                ...
                var n, i = [], r = !1, a = document, o = a.documentElement, s = o.doScroll, c = "DOMContentLoaded", d = "addEventListener", u = "onreadystatechange", l = "readyState", f = s ? /^loaded|^c/ : /^loaded|c/, h = f.test(a[l]);
                return a[d] && a[d](c, n = function () {
                    a.removeEventListener(c, n, r), e()
                }, r), s && a.attachEvent(u, n = function () {
                ...
                return e.styleSheet ? e.styleSheet.cssText = r : e.textContent = r, "1px" === i.width
            } : function (t) {
                if ("" == t)
                    return!0;
                var e, n, i, r, a = {"min-width": null, "max-width": null}, o = !1;
                n = t.split(/\s+and\s+/);
                for (r in n)
                    e = n[r], "(" == e.charAt(0) && (e = e.substring(1, e.length - 1), i = e.split(/:\s+/), 2 == i.length && (a[i[0].replace(/^\s+|\s+$/g, "")] = parseInt(i[1]), o = !0));
                if (!o)
                    return!1;
